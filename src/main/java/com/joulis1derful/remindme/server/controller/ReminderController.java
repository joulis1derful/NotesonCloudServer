package com.joulis1derful.remindme.server.controller;

import com.joulis1derful.remindme.server.entity.Remind;
import com.joulis1derful.remindme.server.service.ReminderService;
...
public class ReminderController {
    ...
    @RequestMapping(value = "/reminders/del/{id}")
    @ResponseBody
